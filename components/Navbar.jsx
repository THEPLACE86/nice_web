...
const Navbar = () => {
    ...
    if (router.pathname === "/quality/testDateList/testListPrint" || router.pathname === "/quality/testDateList/testListCountPrint" || router.pathname === "/quality/testDateList/testListCountPrintM" ) {
        return <></>
    }else{
        return(
